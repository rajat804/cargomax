...
const moduleNavGroups: Record<string, NavGroup[]> = {
  Operations: [
    ...
    },
    {
      ...
      icon: ClipboardList,
      items: [
        { title: "BOOKING COMPUTERIZE GRL", icon: PlusSquare, href: "/shipments/create" },
        { title: "BOOKING GRL MANUAL", icon: FileText, href: "/shipments/manual" },
        { title: "CHANGE VEHICLE IN MANIFEST", icon: Truck, href: "/transactions/change-vehicle-manifest" },
        { title: "DDR", icon: FileText, href: "/transactions/ddr" },
        { title: "DR CHARGE UPDATE", icon: DollarSign, href: "/transactions/dr-charge-update" },
